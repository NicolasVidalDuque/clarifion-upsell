...
const Comment = () => {
  return(
    <div class="frame-1484578050">
  <div class="frame-1484578045">
    <img class="rectangle-1127" src="../../public/rectangle-11272.png" />
    <div class="name">
      <svg
        class="stars"
        width="79"
      ...
      <div class="frame-1000004527">
        <div class="ken-t">Ken T.</div>
        <div class="verify">
  ...
  <div
    className="as-soon-as"
  >
    “As soon as the Clarifions arrived I put one in my bedroom. This was late in
    the afternoon. When I went to the bedroom in the evening it smelled clean.
